...
public class ComptabiliteManagerImpl extends AbstractBusinessManager implements ComptabiliteManager {
	...
	public synchronized void addReference(EcritureComptable pEcritureComptable) {
		...
		String derniereChaine[] = reference.split("/");
		String premiereChaine[] = derniereChaine[0].split("-");
		String code = derniereChaine[1];
		String libelle = premiereChaine[0];
		String date = premiereChaine[1];
		...
		for (EcritureComptable c: ecritures) {
			String cReference = c.getReference();
			String cLastChain[] = cReference.split("/");
			String cFirstChain[] = cLastChain[0].split("-");
			String cDate = cFirstChain[1];
			String cCode = cLastChain[1];

			// Ajoute +1 si le code existe deja
			int cCodeInt = Integer.parseInt(cCode);
		...
		lastNum++;
		String newCode = String.format("%05d",lastNum);
		String newRef = libelle + "-" + date + "/" + newCode;
