...
public class EcritureComptable {
     ...
     * Instantiates a new Journal comptable.
     *
     * @param pid - id de l'ecriture
     * @param pjournal - journal de l'écriture
     * @param preference - reference de l'ecriture
     * @param pdate - date de l'écriture
     * @param plibelle - libelle de l'écriture
     */
    public EcritureComptable(int pid, JournalComptable pjournal, String preference, Date pdate, String plibelle) {
        id = pid;
        journal = pjournal;
    ...
    public void setListLigneEcriture(LigneEcritureComptable ligne){listLigneEcriture.add(ligne);}
